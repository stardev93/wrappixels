...
Route::get('/user-profile/{slug}', 'CommonController@view_user_profile_settings');
Route::get('/user-purchases/{slug}', 'CommonController@view_user_purchases_settings');
Route::get('/user-favourites/{slug}', 'CommonController@view_user_favourites');
Route::get('/user-withdrawals/{slug}', 'CommonController@view_user_withdrawals');
