...
class Settings extends Model
{
	...
	/* general settings */
	  ...
	  public static function getcurrencyData()
	  {
		...
		$value=DB::table('currency')->orderBy('currency_id', 'asc')->get(); 
		return $value;
	...
	public static function savecurrencyData($data){
	...
	public static function deleteCurrencydata($cid){
    
	DB::table('currency')->where('currency_id', '=', $cid)->delete();	
  ...
  public static function editCurrency($cid){
    $value = DB::table('currency')
  ...
  public static function updatecurrencyData($cid,$data){
    DB::table('currency')
      ->where('currency_id', $cid)
      ->update($data);
  }
