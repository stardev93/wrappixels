                           ...
                           <div class="col-md-6">
                            ...
                            <div class="card-body">
                             ...
                             <div class="form-group">
                                                ...
                                                <input id="site_max_file_size" name="site_max_file_size" type="text" class="form-control noscroll_textarea" value="{{ $setting['setting']->site_max_file_size }}" data-bvalidator="required,digit,min[1]"> <small>Example : 1000</small>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                                ...
                                                <input id="aws_bucket" name="aws_bucket" type="text" class="form-control noscroll_textarea" value="{{ $setting['setting']->aws_bucket }}"> <small>Example : yourbucketname</small>
                                            </div>
