...
<link rel="stylesheet" media="screen" href="{{ asset('public/assets/lightbox/topbox.css') }}" />
<link rel="stylesheet" href="{{ asset('public/assets/video/video.css') }}">

<link rel="stylesheet" href="{{ asset('public/assets/filter/jquery-ui.css') }}" />
<link rel="stylesheet" href="{{ asset('public/assets/theme/cookie/cookiealert.css') }}">

@include('dynamic-style')
<link rel="stylesheet" href="{{ asset('resources/views/static-new-style.css') }}">
